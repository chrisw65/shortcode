...
export const DEFAULT_SITE_CONFIG = {
  ...
  smtp: {
    ...
    password: '',
    from_name: 'OkLeaf',
    from_email: 'no-reply@okleaf.link',
    reply_to: '',
  },
  emails: {
    invite: {
  ...
  pages: {
    ...
    features: {
      ...
      cards: [
        ...
        { title: 'Smart routing', text: 'Route by country, device, or platform with priority rules and fallbacks.' },
        { title: 'Amazon ASIN routing', text: 'Create regional Amazon destinations (product, reviews, or write-a-review) from one ASIN.' },
        { title: 'Webhook delivery', text: 'Per-org endpoints with signed payloads, retries, and delivery logs.' },
        { title: 'Affiliate growth', text: 'Track conversions, manage affiliate coupons, and export payouts.' },
    ...
    docs: {
      ...
      html: [
        ...
        '    <p>Shorten any page from your toolbar and copy the short URL.</p>',
        '    <a class="small-link" href="/docs/extensions.html">Install extension</a>',
        '  </div>',
        '  <div class="doc-card">',
        ...
        '  <p class="section-sub">Create an API key in the admin panel and pass it as the <code>X-API-Key</code> header.</p>',
        ...
        '  -d \'{\"url\":\"https://example.com/launch\",\"title\":\"Launch\"}\'</code></pre>',
        '</section>',
        '<section class="section reveal">',
        ...
        '</section>',
        '<section class="section reveal">',
        '  <h2 class="section-title">Amazon ASIN routing</h2>',
        '  <p class="section-sub">Use the Amazon router in the admin panel to build country-specific destinations from one ASIN.</p>',
        '  <div class="doc-card">',
        '    <p><strong>Destinations</strong>: product page, public reviews, write-a-review, review your purchases</p>',
        '    <p><strong>Markets</strong>: US, UK (GB), CA, DE, FR, IT, ES, JP, AU, and more</p>',
        '  </div>',
        '</section>',
        '<section class="section reveal">',
        ...
        '  <p class="section-sub">Push link and click events to your data warehouse or CRM in realtime.</p>',
        '  <div class="doc-card">',
