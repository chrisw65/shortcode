...
ALTER TABLE users ADD COLUMN IF NOT EXISTS totp_verified_at TIMESTAMP NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS totp_last_used TIMESTAMP NULL;
ALTER TABLE orgs ADD COLUMN IF NOT EXISTS ip_anonymization BOOLEAN DEFAULT false;
ALTER TABLE orgs ADD COLUMN IF NOT EXISTS data_retention_days INTEGER;
...
ALTER TABLE links ADD COLUMN IF NOT EXISTS deep_link_url TEXT;
ALTER TABLE links ADD COLUMN IF NOT EXISTS ios_fallback_url TEXT;
ALTER TABLE links ADD COLUMN IF NOT EXISTS android_fallback_url TEXT;
ALTER TABLE links ADD COLUMN IF NOT EXISTS deep_link_enabled BOOLEAN DEFAULT false;
ALTER TABLE domains ADD COLUMN IF NOT EXISTS org_id UUID REFERENCES orgs(id) ON DELETE CASCADE;
...
ALTER TABLE org_sso ADD COLUMN IF NOT EXISTS auto_provision BOOLEAN DEFAULT true;
ALTER TABLE org_sso ADD COLUMN IF NOT EXISTS default_role VARCHAR(20) DEFAULT 'member';
ALTER TABLE org_sso ADD COLUMN IF NOT EXISTS allowed_domains TEXT[] NOT NULL DEFAULT ARRAY[]::text[];
